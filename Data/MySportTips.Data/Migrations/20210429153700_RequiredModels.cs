namespace MySportTips.Data.Migrations
{
    ...
    public partial class RequiredModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Games_Countries_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tips_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tips_Images_ImageId",
                        column: x => x.ImageId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tips_TimePeriods_TimePeriodId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TipTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TipTags_Tips_TipId",
                        column: x => x.TipId,
                        principalTable: "Tips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tips_TimePeriodId",
                table: "Tips",
                column: "TimePeriodId");

            migrationBuilder.CreateIndex(
                name: "IX_TipTags_IsDeleted",
                table: "TipTags",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_TipTags_TagId",
                table: "TipTags",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_TipTags_TipId",
                table: "TipTags",
                column: "TipId");
        }
